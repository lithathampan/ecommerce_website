<?php
    ...
    try{
        if($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sqlToy = "CALL `kiddybuddy`.`sp_add_toy`('$toyname','$toydescription',$salesprice,$discount,'$manufacturer',$subcategory,'$imagefile');";
            ...
            if($count == 1) {
                //session_register("myusername");
                    ...
                    $successmessage = 'Thank you for adding toy. Database is updated. ToyID ='.$row->v_toyid;
            }
        }
      ...
      <div class="row">
        ...
        <div class="row">
            ...
            <?php
             ...
             while($objCat = $categories->fetch_object()) {      
               echo '<option value="'.$objCat->ToyCatId.'" >'.$objCat->CategoryName.'</option>';
             }
                ?>
            </select>
            </div>
        ...
        <div class="row">
            ...
            <?php
                    ...
                    $sqlSubCat = "CALL `kiddybuddy`.`sp_get_categories`('Sub','1');";
        ...
        <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Name of the Toy" name="toyname" value ="<?php if($error <> ""){ echo $_POST['toyname'];}?>">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Name of the Maker" name="manufacturer" value ="<?php if($error <> ""){ echo $_POST['manufacturer'];}?>">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
            <textarea 	id="content" name="toydescription" 	placeholder="Enter Toy Description"></textarea>              
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="number" min="0.01" step="0.01" max="999999.99" id="right-label" placeholder="Sales Price per unit" name="salesprice" value ="<?php if($error <> ""){ echo $_POST['salesprice'];}?>" required>
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="number" min="0.00" step="0.01" max="100.00" id="right-label" placeholder="Discount percentage" name="discount" value ="<?php if($error <> ""){ echo $_POST['discount'];}else{echo "0.00";}?> " required>
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="filename.jpg" name="imagefile" value ="<?php if($error <> ""){ echo $_POST['imagefile'];}?>">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="submit" id="right-label" value="Add Toy" class="labelbutton">
